                ...
                <>
                    {userIncomeData.isAnyTransaction === false ? (
                        ...
                        <div>
                            ...
                            {/* Loop through incomes array */}
                            {userIncomeData.incomes.map((incomeItem, index) => (
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.88rem' }}>
                                        ...
                                        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.22rem' }}>
                                                <span style={{ fontSize: '1.6rem', color: 'var(--color-white--1)' }}>{userIncomeData.incomeCategory}</span>
                                                <span style={{ fontSize: '1.6rem', color: 'var(--color-white--1)' }}>{userIncomeData.incomeDescription}</span>
                                            </div>
